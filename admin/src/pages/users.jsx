                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex gap-2">
                            <button
                              ...
                              disabled={isLoading}
                              className="text-indigo-600 hover:text-indigo-900 text-xs sm:text-sm disabled:opacity-50"
                            >
                              View
                            </button>
                            <button
                ...
                <td className="px-4 py-2 text-sm">
                  ...
                  <span
                    className={`px-2 py-1 rounded-md text-xs font-medium ${
                      statusColors[order.status] || statusColors["Order Placed"]
                    }`}
                  >
