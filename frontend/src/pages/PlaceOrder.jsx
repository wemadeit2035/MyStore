      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {token && (
                    <button
                      ...
                      className="text-sm bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 py-1 rounded-md flex items-center gap-1 transition-colors"
                    >
                      {isLoadingProfile ? (
                        <>
                          <svg
          ...
          >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center">
                        <Wallet size={35} className="text-gray-500 mr-2" />
            ...
            <p className="text-gray-500 text-xs mt-3 mb-3 text-center">
